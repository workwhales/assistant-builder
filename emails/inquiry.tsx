          ...
          <Container className="my-10 mx-auto p-5 w-[465px]">
            ...
            <Section className="text-center mt-[32px] mb-[32px]">
              <Button
                ...
                href={`${
                  (siteConfig as SiteConfig)?.url
                }dashboard/chatbots/${chatbotId}/inquiries`}
              >
            ...
            <Text className="text-sm">
              Cheers,
              <br />
              The {(siteConfig as SiteConfig)?.name} Team
            </Text>
            <Text className="text-center text-gray-400">
              You are subscribed to the emails for Inquiry notifications. To
              manage your communication preferences, click{" "}
              <Link
                className="underline text-gray-400"
                href={`${(siteConfig as SiteConfig)?.url}dashboard/settings`}
              >
                here
              </Link>
            </Text>
